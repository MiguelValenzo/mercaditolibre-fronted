...
const ProductoEditar = ({ id, navegar }) => {
    ...
    useEffect(() => {
        const cargarDatos = async () => {
            try {
                const [producto, cat, prov] = await Promise.all([
                    apiService.getProducto(id),
                ...
                setFormData({
                    ...
                    proveedor: { id: producto.proveedor?.id || '' }
                });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            // ✅ Validar que se seleccionó categoría
            ...
            await apiService.actualizarProducto(id, productoData);
            setExito(true);
            setTimeout(() => {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                onChange={(e) => setFormData({...formData, proveedor: { id: e.target.value }})}
                                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent bg-white"
                            >
