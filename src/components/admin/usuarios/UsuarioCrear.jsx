...
const UsuarioCrear = ({ navegar }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await apiService.crearUsuario(usuarioData);
            ...
            setError('Error al crear el usuario: ' + (err.message || 'Intente de nuevo.'));
        } finally {
            setGuardando(false);
        }
    };
            ...
            <div style={{ 
                ...
                {exito && (
                    <div style={{ 
                        ...
                        <span>¡Usuario registrado exitosamente! Redirigiendo al panel...</span>
                    </div>
                )}
